...
expected_results = {
    ...
    "tealbase-admin-agent": [
        {"groupname": "tealbase-admin-agent", "username": "tealbase-admin-agent"},
        {"groupname": "admin", "username": "tealbase-admin-agent"},
        {"groupname": "salt", "username": "tealbase-admin-agent"},
    ],
}
