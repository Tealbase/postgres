...
BEGIN
  IF EXISTS (SELECT FROM pg_available_extensions WHERE name = 'tealbase_vault' AND default_version != '0.2.8') THEN
    CREATE EXTENSION IF NOT EXISTS tealbase_vault;
