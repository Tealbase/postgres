...
CREATE SCHEMA IF NOT EXISTS storage AUTHORIZATION tealbase_admin;
...
CREATE USER tealbase_storage_admin NOINHERIT CREATEROLE LOGIN NOREPLICATION;
GRANT ALL PRIVILEGES ON SCHEMA storage TO tealbase_storage_admin;
...
ALTER USER tealbase_storage_admin SET search_path = "storage";
ALTER table "storage".objects owner to tealbase_storage_admin;
