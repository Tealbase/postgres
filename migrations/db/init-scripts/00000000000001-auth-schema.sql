...
CREATE SCHEMA IF NOT EXISTS auth AUTHORIZATION tealbase_admin;
...
ALTER table "auth".users OWNER TO tealbase_auth_admin;
ALTER table "auth".refresh_tokens OWNER TO tealbase_auth_admin;
ALTER table "auth".audit_log_entries OWNER TO tealbase_auth_admin;
ALTER table "auth".instances OWNER TO tealbase_auth_admin;
ALTER table "auth".schema_migrations OWNER TO tealbase_auth_admin;
