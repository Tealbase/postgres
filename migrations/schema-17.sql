...
BEGIN
  ...
  THEN
    ...
    alter default privileges for user tealbase_admin in schema cron grant all
...
--
-- Name: tealbase_realtime; Type: PUBLICATION; Schema: -; Owner: -
--

CREATE PUBLICATION tealbase_realtime WITH (publish = 'insert, update, delete, truncate');
