...
Can't find your favorite extension? Suggest for it to be added into future versions [here](https://github.com/tealbase/tealbase/discussions/679)!
...
Finally, this is the same build we offer at [tealbase](https://tealbase.io), and everything we do is opensource. This repo makes it easy to _install_ Postgres, tealbase makes it easy to _use_ Postgres.
